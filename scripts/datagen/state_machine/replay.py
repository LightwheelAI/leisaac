...
parser.add_argument(
    ...
    default=None,
    help=(
        "State machine device type used during recording, e.g. 'so101ik' or "
        "'bi-so101ik'. If not set, inferred from the task name."
    ),
)
